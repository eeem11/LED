...
#define KEY1	GPIO_ReadInputDataBit(GPIOA, KEY1_GPIO_PIN) // 读取按键0
#define KEY2	GPIO_ReadInputDataBit(GPIOA, KEY2_GPIO_PIN) // 读取按键1
#define KEY3	GPIO_ReadInputDataBit(GPIOA, KEY3_GPIO_PIN) // 读取按键3
#define KEY4	GPIO_ReadInputDataBit(GPIOA, KEY4_GPIO_PIN) // 读取按键4
